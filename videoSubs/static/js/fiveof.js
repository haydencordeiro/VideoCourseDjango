...
const messages = [
  ...
  ['there was an error.', 'we goofed up.', 'a bad thing happend.', 'the server crashed.', 'a bug appeared.', , 'pixies got into the server!', 'the server threw a tantrum.', 'the website had a bad day.'],
